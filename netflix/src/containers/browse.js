...
export function BrowseContainer({ slides }) {
  ...
  const [searchTerm, setSearchTerm] = useState('joker');
    ...
    return profile.displayName ? (
        <>
            ...
            <Header.Feature>
                ...
                <Header.Text>
                    Forever alone in a crowd, failed comedian Arthur Fleck sleeks
            ...
            <Card.Group>
                ...
                <Card.Feature category={category} userEmail={user.email} />
                </Card>
                ))}
            </Card.Group>
            <FooterContainer />
