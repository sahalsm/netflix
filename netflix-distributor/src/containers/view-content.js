...
export function ViewContentContainer(userEmail) {
                        ...
                        {isSeries ? 
                            seriesData.map((item, index) => (
                                <tr key={item._id || item.slug}>
                                    ...
                                    <td>{item.maturity}</td>
                                    <td>{item.slug}</td>
                                    <td><Button variant="warning" href={`${ROUTES.EDIT_CONTENT}?slug=${item.slug}&collection=series`}>Edit</Button></td>
                            ...
                            filmsData.map((item, index) => (
                                <tr key={item._id || item.slug}>
                                    ...
                                    <td>{item.maturity}</td>
                                    <td>{item.slug}</td>
                                    <td><Button variant="warning" href={`${ROUTES.EDIT_CONTENT}?slug=${item.slug}&collection=films`}>Edit</Button></td>
